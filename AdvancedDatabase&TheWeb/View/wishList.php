<?php require_once('../Controller/wishList.php'); ?>
<!DOCTYPE html>
<html>
...
<div class="wineListContainer">
     <div class="row2 wine-container">
         <?php foreach ($wishList as $wineID):
           $wine=getWineByID($wineID);?>
         <div class="wine-items" name='Test' id="wineName<?=$wineID?>">
             <div class="wineType">
             ...
             <div class="wine-desc">
                 ...
                 <div class="row">
                   <a class="button" href="" name="addToWishList" rel="<?=$wine->wineID?>" onclick="removeFromWishList(rel);return false;">Remove</a>
                 </div>
